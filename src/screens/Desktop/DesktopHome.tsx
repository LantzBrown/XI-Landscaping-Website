    ...
    <>
      ...
      <section className="relative w-full">
        ...
        <div className="absolute w-full top-[273px] text-center z-10">
          ...
          <p className="font-normal text-[#d6d6d6] text-[26px] mx-auto max-w-4xl">
      ...
      <section className="w-full bg-ligth-gray py-16">
        <div className="container mx-auto px-10">
              ...
              {differentiators.map((item, index) => (
                ...
                >
                  <CardContent className="p-0">
                    ...
                    <p className="font-normal text-[#9c9797] text-xl">
          ...
          <Link to="/contact" onClick={() => window.scrollTo(0, 0)}>
            <Button className="mt-12 w-[250px] h-[60px] bg-[#202e13] hover:bg-[#2d3e1e] rounded-none">
